...
void pc64_send_sd_read_command(void) {
    ...
    // Signal start
    uart_putc_raw(uart0, COMMAND_START);
    uart_putc_raw(uart0, COMMAND_START2);

    // command
    uart_putc_raw(uart0, COMMAND_SD_READ);

    // sector
    uart_putc_raw(uart0, (char)((sector & 0xFF00000000000000) >> 56));
    uart_putc_raw(uart0, (char)((sector & 0x00FF000000000000) >> 48));
    uart_putc_raw(uart0, (char)((sector & 0x0000FF0000000000) >> 40));
    uart_putc_raw(uart0, (char)((sector & 0x000000FF00000000) >> 32));

    uart_putc_raw(uart0, (char)((sector & 0x00000000FF000000) >> 24));
    uart_putc_raw(uart0, (char)((sector & 0x0000000000FF0000) >> 16));
    uart_putc_raw(uart0, (char)((sector & 0x000000000000FF00) >> 8));
    uart_putc_raw(uart0, (char)(sector  & 0x00000000000000FF));

    // num sectors
    uart_putc_raw(uart0, (char)((sectorCount & 0xFF000000) >> 24));
    uart_putc_raw(uart0, (char)((sectorCount & 0x00FF0000) >> 16));
    uart_putc_raw(uart0, (char)((sectorCount & 0x0000FF00) >> 8));
    uart_putc_raw(uart0, (char)(sectorCount & 0x000000FF));

    // Signal finish
    uart_putc_raw(uart0, COMMAND_FINISH);
    uart_putc_raw(uart0, COMMAND_FINISH2);
}
